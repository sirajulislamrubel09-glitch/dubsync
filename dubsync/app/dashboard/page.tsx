  ...
  return (
    <div style={{minHeight:'100vh', background:'#0a0a0f', padding:'24px', fontFamily:'system-ui'}}>
      ...
      <div style={{background:'rgba(139,92,246,0.05)', border:'1px solid rgba(139,92,246,0.2)', borderRadius:'24px', padding:'32px', marginBottom:'24px'}}>
        <h2 style={{color:'white', fontSize:'24px', fontWeight:800, margin:'0 0 8px 0'}}>
          Welcome back! 👋
        </h2>
      ...
      {/* Create Dub Button */}
      <button style={{width:'100%', padding:'20px', borderRadius:'16px', background:'linear-gradient(135deg,#8b5cf6,#a78bfa)', border:'none', color:'white', fontSize:'18px', fontWeight:800, cursor:'pointer', letterSpacing:'1px'}}>
        🎤 Create New Dub
      </button>

      <p style={{textAlign:'center', color:'rgba(255,255,255,0.3)', fontSize:'13px', marginTop:'16px'}}>
        AI Lip Sync feature coming in next update!
      </p>
    </div>
  )
}
